  ...
  return (
    <section className="contact bg-success ">
      <div className="container ">
        ...
        <div className="row">
          <div className="col-4">
           <Card title="Title 1" description="Some Desctiption goes here!! Some Desctiption goes here!! Some Desctiption goes here!! Some Desctiption goes here!! " button="Read More" />
          </div>
          <div className="col-4">
